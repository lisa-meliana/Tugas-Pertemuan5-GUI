        ...
        if (e.getSource() == btnhitung) {
            if (tfpanjang.getText().isEmpty()) {
                ...
                try {
                    ...
                    lblluas.setText("Luas Persegi         : " + balok.hitungLuas());
                    lblkeliling.setText("Keliling Persegi     : " + balok.hitungKeliling());
                    lblvolume.setText("Volume Balok         : " + balok.hitungVolume());
                    lblluaspermukaan.setText("Luas Permukaan Balok : " + balok.hitungLuasPermukaan());
